	...
	return (
		<>
			...
			<div className="flex justify-between">
				<Image
					className="w-2/6 max-w-sm flex-initial rounded-sm border border-primary-800 dark:border-dark-primary-200"
				...
				/>
				<Image
					className="max-w-xs flex-initial rounded-sm border border-primary-800 dark:border-dark-primary-200"
