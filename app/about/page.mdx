import PersonalPhotos from "@/app/about/PersonalPhotos";
...
managed software developers in Seattle. I see my future at the intersection of
writing, code, and game design. Find me on [LinkedIn]({siteMetadata.linkedin}).

I engage with software development as a craft rather than a science or art. I
want to write maintainable code that respects users and delivers practical
value.
